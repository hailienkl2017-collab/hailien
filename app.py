...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Hải Liên - Trường Tiểu học Khuôn Lùng - ĐT: 0971498543</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Hải Liên - Trường tiểu học Khuôn Lùng- ĐT: 0971498543</div>", unsafe_allow_html=True)
